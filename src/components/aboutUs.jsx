      ...
      <section className="py-12 bg-white sm:py-16 lg:py-20">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-blue-900 sm:text-4xl xl:text-5xl font-pj">
              Our Team
            </h2>
          </div>
          ...
          <div className="grid max-w-6xl grid-cols-1 px-20 mx-auto mt-12 text-center sm:px-0 sm:grid-cols-2 md:mt-20 gap-x-8 md:grid-cols-4 gap-y-12 lg:gap-x-16 xl:gap-x-20">
            <div>
              <img
                ...
                alt=""
              />
              <p className="mt-5 text-lg font-bold text-blue-900 sm:text-xl sm:mt-8 font-pj">
                Ankit
              </p>
              <p className="mt-2 text-base font-normal text-blue-950 font-pj">
                Backend developer
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-base font-normal text-blue-950 font-pj">
                Designing the pages and components
              </p>
            </div>
