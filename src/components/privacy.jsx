  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-16 bg-white shadow-lg rounded-2xl mt-8">
      <div className="text-center mb-10">
        ...
        <h1 className="text-4xl font-extrabold text-indigo-700">Privacy Policy</h1>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-indigo-600 mb-2">2. How We Use Your Data</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-2">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-indigo-600 mb-2">3. Data Security</h2>
